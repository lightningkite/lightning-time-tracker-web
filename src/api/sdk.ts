import {
  ...
  export interface Api {
    ...
    readonly comment: {
       ...
       **/
      queryPartial(
        input: QueryPartial<Comment>,
        userToken: string
      ): Promise<Array<DeepPartial<Comment>>>;
    ...
    readonly organization: {
       ...
       **/
      queryPartial(
        input: QueryPartial<Organization>,
        userToken: string
      ): Promise<Array<DeepPartial<Organization>>>;
    ...
    readonly project: {
       ...
       **/
      queryPartial(
        input: QueryPartial<Project>,
        userToken: string
      ): Promise<Array<DeepPartial<Project>>>;
    ...
    readonly task: {
       ...
       **/
      queryPartial(
        input: QueryPartial<Task>,
        userToken: string
      ): Promise<Array<DeepPartial<Task>>>;
    ...
    readonly timeEntry: {
       ...
       **/
      queryPartial(
        input: QueryPartial<TimeEntry>,
        userToken: string
      ): Promise<Array<DeepPartial<TimeEntry>>>;
    ...
    readonly timer: {
       ...
       **/
      queryPartial(
        input: QueryPartial<Timer>,
        userToken: string
      ): Promise<Array<DeepPartial<Timer>>>;
    ...
    readonly user: {
       ...
       **/
      queryPartial(
        input: QueryPartial<User>,
        userToken: string
      ): Promise<Array<DeepPartial<User>>>;
  ...
  export class UserSession {
    ...
    readonly comment = {
      ...
      queryPartial: (
        ...
        return this.api.comment.queryPartial(input, this.userToken);
      },
    ...
    readonly organization = {
      ...
      queryPartial: (
        ...
        return this.api.organization.queryPartial(input, this.userToken);
      },
    ...
    readonly project = {
      ...
      queryPartial: (
        ...
        return this.api.project.queryPartial(input, this.userToken);
      },
    ...
    readonly task = {
      ...
      queryPartial: (
        ...
        return this.api.task.queryPartial(input, this.userToken);
      },
    ...
    readonly timeEntry = {
      ...
      queryPartial: (
        ...
        return this.api.timeEntry.queryPartial(input, this.userToken);
      },
    ...
    readonly timer = {
      ...
      queryPartial: (
        ...
        return this.api.timer.queryPartial(input, this.userToken);
      },
    ...
    readonly user = {
      ...
      queryPartial: (
        ...
        return this.api.user.queryPartial(input, this.userToken);
      },
  ...
  export class LiveApi implements Api {
    public constructor(
      ...
      public responseInterceptors?: (x: Response) => Response
    ) {}
